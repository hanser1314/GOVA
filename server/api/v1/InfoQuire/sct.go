...
// @Param data body InfoQuire.Sct true "创建选课信息表"
...
// @accept application/json
// @Produce application/json
// @Param data body InfoQuire.Sct true "删除选课信息表"
...
// DeleteSctByIds 批量删除选课信息表
// @Tags Sct
// @Summary 批量删除选课信息表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body request.IdsReq true "批量删除选课信息表"
...
// @accept application/json
// @Produce application/json
// @Param data body InfoQuire.Sct true "更新选课信息表"
...
// @accept application/json
// @Produce application/json
// @Param data query InfoQuire.Sct true "用id查询选课信息表"
...
// GetSctList 分页获取选课信息表列表
// @Tags Sct
// @Summary 分页获取选课信息表列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query InfoQuireReq.SctSearch true "分页获取选课信息表列表"
...
func (sctApi *SctApi) GetSctListByUsername(c *gin.Context) {
	var pageInfo InfoQuireReq.SctSearchByUsername
	err := c.ShouldBindQuery(&pageInfo)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
		return
	}
	if list, total, err := sctService.GetSctInfoListByUsername(pageInfo); err != nil {
		global.GVA_LOG.Error("获取失败!", zap.Error(err))
		response.FailWithMessage("获取失败", c)
	} else {
		response.OkWithDetailed(response.PageResult{
