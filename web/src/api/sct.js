...
// @Param data body model.Sct true "创建选课信息表"
...
// @accept application/json
// @Produce application/json
// @Param data body model.Sct true "删除选课信息表"
...
// @accept application/json
// @Produce application/json
// @Param data body model.Sct true "更新选课信息表"
...
// @accept application/json
// @Produce application/json
// @Param data query model.Sct true "用id查询选课信息表"
...
// @accept application/json
// @Produce application/json
// @Param data query request.PageInfo true "分页获取选课信息表列表"
